...
let carrosDaConcessionaria: Array<Carro> = concessionaria.mostrarListaDeCarros();

carrosDaConcessionaria.forEach(carro => {
...
// map faz um loop em cada posicao do array ao enviarmos uma funcao de callback como parametro
// semelhante a um for each
let listaCarros = concessionaria.mostrarListaDeCarros().map((carro: Carro) => { 
